...
open class FaceAndColorDetectImageView : ShapeableImageView {
    ...
    fun loadImage(uri: Uri?, cropped: Boolean = true, emptyPlaceholder: Boolean = false, listener: OnImageLoadListener? = null) {
