...
public class ArrayModel extends Model {
    ...
    public void vertexCount(int count) {
        vertexCount = count;
    }

    @Nullable private FloatBuffer vertexBuffer;
    public FloatBuffer vertexBuffer() {
        return vertexBuffer;
    }
    public void vertexBuffer(FloatBuffer buffer) {
        vertexBuffer = buffer;
    }

    @Nullable private FloatBuffer normalBuffer;
    public FloatBuffer normalBuffer() {
        return normalBuffer;
    }
    public void normalBuffer(FloatBuffer buffer) {
        normalBuffer = buffer;
    }
    ...
    public void init(float boundSize) {
        ...
        glProgram(GlUtil.compileProgram(R.raw.model_vertex, R.raw.single_light_fragment,
